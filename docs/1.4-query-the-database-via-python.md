...
3. Once your script has been uploaded, connect to Trillium [as described earlier](https://mdlutoronto.github.io/wos-postgresql-database-getting-started/1.1-access-the-high-performance-computing-environment/)
